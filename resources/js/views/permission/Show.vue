    ...
    <v-container fluid>
        ...
        <v-card>
            <v-card-subtitle>
                ...
                <v-btn class="ma-1" color="warning" :to="{ name: 'permission.edit' }"><v-icon left>mdi-pencil-box-outline</v-icon>Edit permission</v-btn>
            </v-card-subtitle>
...
export default {
    ...
    methods:
    {
        fetchData()
        {
            axiosApiInstance.get(`permission/${ this.$route.params.permission }`)
            .then(response => {
